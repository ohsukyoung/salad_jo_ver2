...
//        allProductList.add(new Product(28,ProductType.SIDE,4,"콘치즈스프","100g",243,150,5,2500,true));
        ...
        masterProductList.add(new MasterRc(1, ProductType.RCMND, "시저치킨샐러드",4000, 3500, r_products1,10,50,true));
        ...
        masterProductList.add(new MasterRc(2, ProductType.RCMND, "콥샐러드",4000, 2500, r_products2,10,50,true));
        ...
        masterProductList.add(new MasterRc(3, ProductType.RCMND, "연어샐러드", 4000, 3000, r_products3,10,50,false));
